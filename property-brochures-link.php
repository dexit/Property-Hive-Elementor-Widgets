	...
	protected function render() {
		...
		if ( get_option('propertyhive_brochures_stored_as', '') == 'urls' )
        {
            ...
            if ( !empty($brochure_urls) )
			{
				...
				{
					echo'<div class="brochure-button-modal-wrapper">
								<a href="' . $brochure['url'] . '" target="_blank" rel="nofollow" data-fancybox class="brochure_link">
								<div class="brochure-icon iconbox">';
					 \Elementor\Icons_Manager::render_icon( $settings["icon"], [ "aria-hidden" => "true" ] );
					echo '</div>
								<div class="brochure-icon text">
        ...
        else
        {
			...
			if ( !empty($brochure_attachment_ids) )
			{
				...
				{
					echo'<div class="brochure-button-modal-wrapper">
								<a href="' . wp_get_attachment_url($attachment_id) . '" target="_blank" rel="nofollow" data-fancybox class="brochure_link">
								<div class="brochure-icon iconbox">';
					 \Elementor\Icons_Manager::render_icon( $settings["icon"], [ "aria-hidden" => "true" ] );
					echo '</div>
								<div class="brochure-icon text">
